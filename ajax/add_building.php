...
$result = mysql_query("INSERT INTO `cml`.`tbl_building` (`building_name`, `desc`, `floor`, `distance_g1`, `distance_g2`, `no_steps_1`, `no_steps_2`) VALUES ('$building_name', '$desc', '$floor_no', '$d_g1', '$d_g2', '$no_s1', '$no_s2')");
if ($result) {
	echo 1;
}else{
	echo 0;
