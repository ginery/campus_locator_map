    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border: 3px solid #4e4e4e;">
            <div class="modal-header" style="padding: 5px; background: #f3f3f3; border-bottom: 1px solid #4e4e4e;">
                <h4 style="font-size: 17px;" class="modal-title">Legend</h4>
            ...
            <div class="modal-body">
                <div class="col-sm-6  style="float: left;">
                        ...
                        <ul>
                            ...
                            <li style="list-style-type: none;">
                                <i class="icofont icofont-foot-print text-primary"></i> - Footsteps
                            </li>
                            <li style="list-style-type: none;">
                                <i class="icofont icofont-disc" style="color: #58ff74"></i> - Shortest Way
                            </li>
                            <li style="list-style-type: none;">
                                <i class="icofont icofont-disc" style="color: #fd4600;"></i> - Longest Way
                            </li>
                        </ul>                      
