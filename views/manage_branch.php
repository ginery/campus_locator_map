<?php require 'modals/add_branch.php';?>
<?php require 'modals/edit_branch.php';?>
...
<div class="card-block inverse-breadcrumb">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="index.php?page=<?php echo url_page('manage-branch');?>">Manage Branch</a>
            </li>
        </ul>
    </div>
</div>
...
<div class="card">
    <div class="card-header" >
         <button type="button" style="float:right;"  class="btn btn-danger waves-effect" onclick="delBranch()" id="btnModalDelete">Delete</button>
         <button type="button" style="float:right; margin-right: 3px;" class="btn btn-info waves-effect" onclick="addBranch()" id="btnModalAdd">Add</button>
         <br>
         <br>
          <hr>
    </div>
    ...
    <div class="card-block">
        <div class="table-responsive dt-responsive">
            <table id="dt_branch" class="table table-striped table-bordered nowrap"  style="width: 100%; font-size: 12px;">
                <thead>
                    <tr>
                        <th style="width: 36px;">
...
$.post("../ajax/getBranch.php",{
  ...
  // alert(o.id);
    $("#branch_nameID").val(o.id);
    $("#branch_nameEdit").val(o.branch_name);
...
function dt_branch(){
  ...
  $("#dt_branch").DataTable().destroy();
  $("#dt_branch").dataTable({
    filter: true,
    "bSort": true,
    "ajax":{
      "url": "../ajax/datatables/dt_branch.php",
      "dataSrc":"data",
      "type":"POST"
    },
    "columns":[
    ...
    },
    {
      "mRender": function(data,type,row){
              return '<div class="dropdown-inverse dropdown open"><button class="btn btn-inverse dropdown-toggle waves-effect waves-light" type="button" id="dropdown-7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-cog"></i></button>'+
                    ...
                    '<a class="dropdown-item waves-light waves-effect" onclick="editBranch('+row.u_id+')" href="#"><i class="zmdi zmdi-edit"></i> Edit Details</a>'+
              "</div></div>";
      }
    },
    {
