...
<div class="card-block inverse-breadcrumb">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="index.php?page=<?php echo url_page('manage-account');?>">Manage Account</a>
            </li>
        </ul>
    </div>
</div>
...
function dt_user(){
  ...
  $("#dt_user").dataTable({
    ...
    "bSort": true,
    "ajax":{
      "url": "../ajax/datatables/dt_user_account.php",
      "dataSrc":"data",
      "type":"POST"
    },
    "columns":[
    ...
    },
    {
      "mRender": function(data,type,row){
              return '<div class="dropdown-inverse dropdown open"><button class="btn btn-inverse dropdown-toggle waves-effect waves-light" type="button" id="dropdown-7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-cog"></i></button>'+
                    ...
                    '<a class="dropdown-item waves-light waves-effect" onclick="viewUser('+row.u_id+')" href="#"><i class="zmdi zmdi-eye"></i> View Details</a>'+
                    '<a class="dropdown-item waves-light waves-effect" onclick="editUser('+row.u_id+',\''+row.fname+'\',\''+row.lname+'\')" href="#"><i class="zmdi zmdi-edit"></i> Edit Details</a>'+
              "</div></div>";
      }
    },
    {
