...
<?php require 'modals/add_user_account.php';?>
...
<div class="card-block inverse-breadcrumb">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="index.php?page=<?php echo url_page('manage-user');?>">Manage Users</a>
            </li>
        </ul>
    </div>
</div>
...
<div class="card">
    <div class="card-header" >
         ...
         <button type="button" style="float:right; margin-right: 3px;" class="btn btn-info waves-effect" onclick="btnModalAdd()">Add</button>
         <br>
         <br>
          <hr>
    </div>
...
function editUser(id,fname,lname,role){
$("#iddNi").val(id);
$("#fnameEdit").val(fname);
$("#lnameEdit").val(lname);
$('#selectOpt option[value="'+role+'"]').prop('selected', true);
$("#modalEdit").modal({
  backdrop: 'static',
  keyboard: false
});
...
function dt_user(){
  ...
  $("#dt_user").dataTable({
    ...
    "bSort": true,
    "ajax":{
      "url": "../ajax/datatables/dt_users.php",
      "dataSrc":"data",
      "type":"POST"
    },
    "columns":[
    ...
    },
    {
      "mRender": function(data,type,row){
              return '<div class="dropdown-inverse dropdown open"><button class="btn btn-inverse dropdown-toggle waves-effect waves-light" type="button" id="dropdown-7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-cog"></i></button>'+
                    ...
                    '<a class="dropdown-item waves-light waves-effect" onclick="editUser('+row.id+',\''+row.fname+'\',\''+row.lname+'\',\''+row.role_id+'\')" href="#"><i class="zmdi zmdi-edit"></i> Edit Details</a>'+
              "</div></div>";
      }
    },
    {
